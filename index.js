...
function nextNewYear() {
  ...
  const nextDateYear = new Date(currentYear +1, 0, +1)
  // Визначаємо кількість мілісекунд до наступного Нового року в змінну diff.
  const diff = nextDateYear.getTime() - date.getTime()
...
function addDays(date, days) {
  ...
  return {isoDate, days, resultDate}
}
...
function getDayOfWeek(date) {
  ...
  let indexOfWeek = date.getDay()
  // Отримання назви дня тижня з масиву daysOfWeek за індексом.
  let dayOfWeek =  daysOfWeek[indexOfWeek]
...
function getDaysInMonth(date) {
  ...
  let nextMonth = new Date(inputYear, inputMonth + 1, 1)
...
function getAge(birthDate) {
  ...
  let saveAge = birthDate.toISOString()
...
function compareDates(date1, date2) {
  ...
  let saveDate1 = date1.toISOString()
  let saveDate2 = date2.toISOString()
  // Повертаємо об'єкт з порівнюваними датами та результатом порівняння.
  return {saveDate1, saveDate2, comparison}
}
...
function getDaysDifference(startDate, endDate) {
  ...
  let milliseconds1 = startDate.getTime()
  let milliseconds2 = endDate.getTime()
  // Різниця в мілісекундах між двома датами.
  let comparison = milliseconds2 - milliseconds1
  // Перетворення різниці в мілісекундах у дні поділивши мілісекунди на (1000 * 60 * 60 * 24).
  let daysDifference = comparison / (1000 * 60 * 60 * 24)
  // Збереження дат для виведення в форматі ISO.
