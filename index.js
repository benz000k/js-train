...
function compareArrays(arr1, arr2) {
  ...
  console.assert(JSON.stringify(arr1) === JSON.stringify(arr2), "Масиви не одинакові!")
}
...
function buildMatrix(size) {
  ...
  // Генеруємо випадкове число від 0 до 9 округляємо його до меншого цілого, і додаємо його до рядка.
    strArr.push(Math.floor(Math.random() * 10))
  }
...
function validateUserInput(userInput) {
  ...
  console.assert(!'password'.length < 8, console.warn("Попередження: пароль має бути довшим за 8 символів!"))
}
